if not _PREMAKE_VERSION then
   os.execute('premake4 --file=premake4_vs2008_r7.lua clean')
   os.execute('premake4 --file=premake4_vs2008_r7.lua vs2008')
   return
end
...
solution "libks"
   ...
   project "libks"
      ...
      files { "include/**.h", 
			  ...
			  "platform/src/win32/win32_system_r7.c", 
			  "platform/src/common/**.h", 
			  "platform/src/common/**.c", 
			  "platform/src/graphics/r7/**.h", 
			  "platform/src/graphics/r7/**.c", 
			  "src/**.h", "src/**.c" }
