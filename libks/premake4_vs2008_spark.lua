if not _PREMAKE_VERSION then
   os.execute('premake4 --file=premake4_vs2008_spark.lua clean')
   os.execute('premake4 --file=premake4_vs2008_spark.lua vs2008')
   return
end
...
solution "libks"
   ...
   project "libks"
      ...
      links { "libEGL", "libGLESv2", "zlib", "libpng" }
      ...
      files { "include/**.h", 
			  ...
			  "platform/src/win32/win32_system_spark.c", 
