...
/* not implemented, just added to compile  */
  /*
INLINE_GL void glPointSize(float) {}
INLINE_GL void glLineWidth(float) {}
INLINE_GL void glDeleteLists(int, int) {}
INLINE_GL void glDepthFunc(int) {}
INLINE_GL void glBlendFunc(int, int) {}
INLINE_GL void glTexEnvf(int, int, int) {}
INLINE_GL void glOrtho(float,float,float,float,float,float){}
INLINE_GL void glVertex2i(int,int) {}
INLINE_GL void glDepthMask(int) {}
INLINE_GL void glFogi(int, int) {}
INLINE_GL void glFogfv(int, const float*) {}
INLINE_GL void glFogf(int, float) {}
INLINE_GL void glRasterPos2f(float, float) {}
INLINE_GL void glPolygonStipple(void*) {}
INLINE_GL void glTexParameterf(int, int, int) {};
  */
